...
def cut_datasets():
    for dataset in ['journal']:
        ...
        with open('/content/journal-train-stemmed.txt', 'w') as f:
            f.write('\n'.join(train_cases))
        with open('/content/journal-dev-stemmed.txt', 'w') as f:
            f.write('\n'.join(dev_cases))
        with open('/content/journal-test-stemmed.txt', 'w') as f:
            f.write('\n'.join(test_cases))
...
class Ohsumed(object):
    ...
    def make_set(self):
        ...
        with open('journal-stemmed.txt', 'w') as f:
            f.write('\n'.join(result))
